...
import { spendingKinds } from '../data/spendingAnalytics';
const iconPaths = [
...
export function SpendingRows({ period }: {period:number}) {
  return <div className="insight-category-list">{useSpending(period).categories.map(row => <div className="insight-category" key={row.name}>
